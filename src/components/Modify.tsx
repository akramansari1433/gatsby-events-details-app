...
export default function Modify() {
    ...
    const [retryConfig, setRetryConfig] = useState<TRetryConfigType>(emptyRetryConfigData);
    ...
    const [showRetryConfigForm, setShowRetryConfigForm] = useState<boolean>(false);
                    ...
                    <>
                        <div className="w-96">
                            <div className="flex flex-row items-center justify-between p-2">
                                ...
                                <div>
                                    <input onChange={(e) => retryConfigChangeHandler(e, 'retry')} className="border-2 p-1" type="number" value={retryConfig.retry} />
                                </div>
                            </div>
                            <div className="flex flex-row items-center justify-between p-2">
                                <div>
